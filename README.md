...
```mermaid
graph TD
    CORE(("🌟 CORE<br/>Engineering Vision"))
    CORE --> P1["🪐 PLANET AETHER<br/>Artificial Intelligence"]
    CORE --> P2["🌍 PLANET FORGE<br/>Software Engineering"]
    CORE --> P3["🔴 PLANET RELAY<br/>Automation Systems"]
    CORE --> P4["🌑 PLANET VOYAGE<br/>Space Technology"]

    P1 --> M1((Prompt Engineering))
    P1 --> M2((Applied AI Tooling))
    P2 --> M3((Backend Systems))
    P2 --> M4((Languages))
    P3 --> M5((AI Automation))
    P4 --> M6((Exploratory Research))

    style CORE fill:#0d1117,stroke:#f7b731,stroke-width:2px,color:#f7b731
    style P1 fill:#0d1117,stroke:#00d2ff,stroke-width:2px,color:#00d2ff
    style P2 fill:#0d1117,stroke:#7ee787,stroke-width:2px,color:#7ee787
    style P3 fill:#0d1117,stroke:#ff7b72,stroke-width:2px,color:#ff7b72
    style P4 fill:#0d1117,stroke:#d2a8ff,stroke-width:2px,color:#d2a8ff
```
...
timeline
    ...
    Launch Phase : Orbital Intelligence Platform — AI-driven engineering console
    Transit Phase : Global Chat Web — real-time cross-orbit communication
    Experimental Phase : AI Playground — sandbox for untested trajectories
```
...
```mermaid
graph LR
    A((Orbital<br/>Intelligence)) --- B((Global<br/>Chat Web))
    B --- C((AI<br/>Playground))
    C --- A
    A -.-> D[[AI Systems]]
    B -.-> E[[Real-Time Comms]]
    C -.-> F[[Prompt Design]]

    style A fill:#0d1117,stroke:#00d2ff,color:#00d2ff
    style B fill:#0d1117,stroke:#7ee787,color:#7ee787
    style C fill:#0d1117,stroke:#ff7b72,color:#ff7b72
    style D fill:#0d1117,stroke:#484f58,color:#8b949e
    style E fill:#0d1117,stroke:#484f58,color:#8b949e
    style F fill:#0d1117,stroke:#484f58,color:#8b949e
```
...
<img src="https://github-readme-stats.vercel.app/api?username=Aswinsudhan&show_icons=true&theme=tokyonight&hide_border=true&bg_color=0d1117&title_color=00d2ff&icon_color=7ee787&text_color=c9d1d9" width="49%" />
<img src="https://github-readme-streak-stats.herokuapp.com/?user=Aswinsudhan&theme=tokyonight&hide_border=true&background=0d1117&ring=00d2ff&fire=ff7b72&currStreakLabel=00d2ff" width="49%" />

<img src="https://github-readme-stats.vercel.app/api/top-langs/?username=Aswinsudhan&layout=compact&theme=tokyonight&hide_border=true&bg_color=0d1117&title_color=00d2ff&text_color=c9d1d9" width="49%" />

<img src="https://github-readme-activity-graph.vercel.app/graph?username=Aswinsudhan&theme=tokyo-night&hide_border=true&bg_color=0d1117&color=00d2ff&line=7ee787&point=ff7b72" width="98%" />
